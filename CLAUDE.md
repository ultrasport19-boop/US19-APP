...
> ```
> Al 21-sep-2026: 39.609 líneas · 10 aperturas · **3 bloques reales** · 2.377 fichas.
...
| `node tools/mutantes.js <lista>` | **Pone a prueba las pruebas**: aplica cada mutante y comprueba que la suite se pone roja. Trabaja sobre una COPIA — nunca toca `index.html`. Listas: `escalera` (24), `guardas` (7), `arranque` (8) y `navegador` (2) |
